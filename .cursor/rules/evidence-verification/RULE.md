---
description: "Exit code validation, test result capture, build log analysis, and evidence templates"
alwaysApply: false
---
...
Exit code validation, test result capture, build log analysis, and evidence templates

## When to apply

- Apply when the task matches the capability keywords/triggers for this skill.
- If unsure, open `@.claude/skills/evidence-verification/capabilities.json` and check `capabilities.*.solves`.

Trigger hints from `capabilities.json` (keep this lightweight): `verify.*success, capture.*evidence, prove.*completed, check.*passed, evidence`
...
- `@.claude/skills/evidence-verification/capabilities.json` (discovery + triggers)
- `@.claude/skills/evidence-verification/SKILL.md` (overview + patterns)
- Templates: `@.claude/skills/evidence-verification/templates/`
- Examples: `@.claude/skills/evidence-verification/examples/`
