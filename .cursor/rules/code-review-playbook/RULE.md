...
- If unsure, open `@.claude/skills/code-review-playbook/capabilities.json` and check `capabilities.*.solves`.

Trigger hints from `capabilities.json` (keep this lightweight): `review.*code, pr.*review, check.*this, feedback.*on, look.*at, what.*think`
...
- `@.claude/skills/code-review-playbook/capabilities.json` (discovery + triggers)
- `@.claude/skills/code-review-playbook/SKILL.md` (overview + patterns)
- Templates: `@.claude/skills/code-review-playbook/templates/`
- Checklists: `@.claude/skills/code-review-playbook/checklists/`
