...
const exampleGroups: StageGroup[] = [
  ...
  },
  {
    ...
    icon: FileText,
    stages: ['tech_comparison', 'security_audit', 'implementation_planning'],
  ...
  },
  {
    ...
    label: 'Validation',
    icon: Shield,
    stages: ['fact_validation', 'source_credibility'],
  ...
  },
  {
    ...
    label: 'Quality',
    icon: Code,
    stages: ['aggregation', 'quality_validation', 'artifact_generation'],
