...
export const STAGE_ORDER_CONSTANTS = {
  // Pipeline stages (1-29)
  // Core workflow (1-3)
  STAGE_EXTRACTION: 1,
  STAGE_CHUNKING: 2,
  STAGE_EMBEDDING: 3,
  // Content-based agents (4-10)
  ...
  // Tier 1: Universal agents (11-14)
  STAGE_TIER1_KEY_INSIGHTS: 11,
  STAGE_TIER1_PROS_CONS: 12,
  STAGE_TIER1_AUDIENCE_FIT: 13,
  STAGE_TIER1_ACTIONABLE: 14,
  // Tier 2: Validation agents (15-18)
  STAGE_TIER2_FACT_VALIDATION: 15,
  STAGE_TIER2_SOURCE_CREDIBILITY: 16,
  STAGE_TIER2_FRESHNESS_CHECK: 17,
  STAGE_TIER2_ALTERNATIVES_FINDING: 18,
  // Tier 3: Research agents (19-22)
  STAGE_TIER3_DEEP_RESEARCH: 19,
  STAGE_TIER3_COMMUNITY_PULSE: 20,
  STAGE_TIER3_KNOWLEDGE_CURATION: 21,
  STAGE_TIER3_LEARNING_PATH: 22,
  // Quality stages (23-25)
  STAGE_QUALITY_AGGREGATION: 23,
  STAGE_QUALITY_VALIDATION: 24,
  STAGE_QUALITY_GENERATION: 25,
  // Optional workflow stages (26-29)
  STAGE_ARTIFACT_CHUNKING: 26,
  STAGE_ARTIFACT_WORKFLOW: 27,
  STAGE_ARTIFACT_PATTERN_COMPARISON: 28,
  STAGE_ARTIFACT_METRICS: 29,
} as const
