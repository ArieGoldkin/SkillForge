"""Community pulse agent node for LangGraph StateGraph.
...
Issue #500: Tier 3 Research agent for community sentiment analysis.
"""
...
from app.domains.analysis.workflows.tasks.runners import (
    ...
    run_community_pulse_with_session,
)

logger = get_logger(__name__)


@observe(as_type="agent", name="community_pulse", capture_input=True, capture_output=True)
async def community_pulse_node(state: AnalysisState) -> dict[str, object]:
    """Execute community pulse analysis.

    Executes community sentiment and trend analysis and returns findings.
    ...
    Issue #500: Tier 3 Research agent with Tavily + optional GitHub search.
    ...
    update_current_trace(
        ...
        tags=["parallel-execution", "tier3", "research"],
