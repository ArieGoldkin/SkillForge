...
AGENT_RUBRICS: Final[dict[str, dict]] = {
    "tech_comparator": {
        ...
        "rubrics": {
            "completeness": {
                ...
                3: (
                    "Compares 3-4 dimensions (performance/scalability/DX/use cases) "
                    "with basic detail"
                ),
    ...
    "artifact_generator": {
        ...
        "rubrics": {
            "completeness": {
                ...
                5: (
                    "Comprehensive guide with all sections thoroughly developed, examples, "
                    "and edge cases"
                ),
            },
            "accuracy": {
    ...
    # ========================================================================
    # TIER 1: UNIVERSAL AGENTS (Always run on ALL content)
    # ========================================================================
    "key_insights": {
        "criteria": ["completeness", "accuracy", "depth", "grounding"],
        "weights": {"completeness": 0.30, "accuracy": 0.25, "depth": 0.25, "grounding": 0.20},
        "rubrics": {
            "completeness": {
                1: "No insights extracted or completely off-topic",
                2: "Only 1-2 superficial observations, missing main themes",
                3: "Captures 3-5 key points but lacks prioritization",
                4: "Comprehensive insights with clear hierarchy and importance",
                5: "Exhaustive extraction with themes, patterns, and implications",
            },
            "accuracy": {
                1: "Insights contradict or misrepresent source content",
                2: "Some insights are inaccurate or exaggerated",
                3: "Generally accurate but some claims lack support",
                4: "Accurate insights with clear grounding in source",
                5: "Precise insights with exact references to source material",
            },
            "depth": {
                1: "Surface-level observations only",
                2: "Basic insights without analysis",
                3: "Moderate depth with some analytical elements",
                4: "Deep insights revealing non-obvious patterns",
                5: "Expert-level analysis with implications and connections",
            },
            "grounding": {
                1: "Insights fabricated or not present in source",
                2: "Multiple ungrounded claims",
                3: "Most insights traceable but some speculation",
                4: "Nearly all insights grounded in source",
                5: "Every insight directly traceable to source content",
            },
        },
    },
    "pros_cons": {
        "criteria": ["completeness", "balance", "accuracy", "actionability"],
        "weights": {"completeness": 0.25, "balance": 0.30, "accuracy": 0.25, "actionability": 0.20},
        "rubrics": {
            "completeness": {
                1: "Missing pros or cons entirely",
                2: "Only 1-2 items per side, major gaps",
                3: "Covers main pros/cons (3-5 each)",
                4: "Thorough coverage with nuanced trade-offs",
                5: "Exhaustive analysis including edge cases and contexts",
            },
            "balance": {
                1: "Heavily biased to one side",
                2: "Noticeable bias with weak counter-arguments",
                3: "Attempts balance but uneven depth",
                4: "Fair treatment of both sides",
                5: "Perfectly balanced with context-specific trade-offs",
            },
            "accuracy": {
                1: "Major factual errors in pros/cons claims",
                2: "Some inaccuracies or exaggerations",
                3: "Generally accurate but lacks evidence",
                4: "Accurate with supporting evidence",
                5: "Highly accurate with verifiable claims",
            },
            "actionability": {
                1: "No guidance on decision-making",
                2: "Vague implications without recommendations",
                3: "Basic decision criteria mentioned",
                4: "Clear decision framework based on trade-offs",
                5: "Actionable decision matrix with scenario guidance",
            },
        },
    },
    "audience_fit": {
        "criteria": ["completeness", "accuracy", "depth", "actionability"],
        "weights": {"completeness": 0.25, "accuracy": 0.25, "depth": 0.25, "actionability": 0.25},
        "rubrics": {
            "completeness": {
                1: "No audience analysis provided",
                2: "Only identifies one audience segment superficially",
                3: "Covers 2-3 audience types with basic fit assessment",
                4: "Thorough audience mapping with skill prerequisites",
                5: "Comprehensive segmentation with learning paths per audience",
            },
            "accuracy": {
                1: "Completely wrong audience assessment",
                2: "Mismatched skill level or domain assumptions",
                3: "Generally accurate but some misalignments",
                4: "Accurate audience-content fit assessment",
                5: "Precise fit analysis with evidence from content",
            },
            "depth": {
                1: "No skill level or prerequisite analysis",
                2: "Basic beginner/advanced classification only",
                3: "Moderate depth with some prerequisite identification",
                4: "Deep analysis of skill gaps and learning curves",
                5: "Expert segmentation with personalized recommendations",
            },
            "actionability": {
                1: "No actionable recommendations",
                2: "Vague suggestions without specifics",
                3: "Basic recommendations for target audience",
                4: "Clear next steps for each audience segment",
                5: "Detailed learning roadmap per audience type",
            },
        },
    },
    "actionable": {
        "criteria": ["completeness", "feasibility", "clarity", "prioritization"],
        "weights": {
            "completeness": 0.25,
            "feasibility": 0.25,
            "clarity": 0.25,
        ...
        "rubrics": {
            "completeness": {
                1: "No actionable items extracted",
                2: "Only 1-2 vague action items",
                3: "Covers main actionable items (3-5)",
                4: "Comprehensive action list with dependencies",
                5: "Exhaustive actionable roadmap with milestones",
            },
            "feasibility": {
                1: "Actions are impossible or unrealistic",
                2: "Significant feasibility concerns unaddressed",
                3: "Generally feasible but assumptions unclear",
                4: "Realistic actions with clear prerequisites",
                5: "Highly feasible with effort estimates and constraints",
            },
            "clarity": {
                1: "Vague or ambiguous action descriptions",
                2: "Actions lack specific steps or outcomes",
                3: "Basic clarity with some specifics",
                4: "Clear actions with defined outcomes",
                5: "Crystal clear with measurable success criteria",
            },
            "prioritization": {
                1: "No prioritization or random ordering",
                2: "Poor prioritization ignoring dependencies",
                3: "Basic priority levels (high/medium/low)",
                4: "Good prioritization with rationale",
                5: "Optimal prioritization with impact/effort analysis",
            },
        },
    },
    # ========================================================================
    ...
    # ========================================================================
    "fact_validator": {
        "criteria": ["completeness", "accuracy", "evidence_quality", "grounding"],
        "weights": {
            "completeness": 0.25,
            "accuracy": 0.30,
        ...
        "rubrics": {
            "completeness": {
                1: "No fact-checking performed",
                2: "Only 1-2 claims verified, major gaps",
                3: "Key claims verified (50-70%)",
                4: "Most claims verified with sources",
                5: "All verifiable claims checked with evidence",
            },
            "accuracy": {
                1: "Verification results are wrong",
                2: "Some verification errors or false positives",
                3: "Generally accurate verification",
                4: "Accurate with clear true/false/unverifiable labels",
                5: "Precise verification with confidence levels",
            },
            "evidence_quality": {
                1: "No evidence or sources provided",
                2: "Weak or unreliable sources cited",
                3: "Basic sources with some authority",
                4: "Quality sources with clear citations",
                5: "Authoritative sources with direct quotes/links",
            },
            "grounding": {
                1: "Fabricates verification results",
                2: "Some ungrounded verification claims",
                3: "Mostly grounded but some assumptions",
                4: "Nearly all verifications grounded",
                5: "Every verification traceable to source",
            },
        },
    },
    "source_credibility": {
        "criteria": ["completeness", "accuracy", "depth", "actionability"],
        "weights": {"completeness": 0.25, "accuracy": 0.30, "depth": 0.25, "actionability": 0.20},
        "rubrics": {
            "completeness": {
                1: "No credibility assessment provided",
                2: "Only surface-level assessment (1-2 factors)",
                3: "Covers main credibility factors (author, date, domain)",
                4: "Thorough assessment with bias and funding analysis",
                5: "Comprehensive credibility audit with verification",
            },
            "accuracy": {
                1: "Credibility assessment is completely wrong",
                2: "Some credibility claims are inaccurate",
                3: "Generally accurate assessment",
                4: "Accurate with evidence for each rating",
                5: "Precise assessment with verifiable indicators",
            },
            "depth": {
                1: "No analysis of credibility factors",
                2: "Basic good/bad classification only",
                3: "Moderate depth with some reasoning",
                4: "Deep analysis of biases and motivations",
                5: "Expert-level credibility forensics",
            },
            "actionability": {
                1: "No recommendations based on credibility",
                2: "Vague warnings without guidance",
                3: "Basic trust/distrust recommendations",
                4: "Clear guidance on what to trust/verify",
                5: "Actionable verification checklist provided",
            },
        },
    },
    "freshness_checker": {
        ...
        "rubrics": {
            "completeness": {
                1: "No freshness analysis provided",
                2: "Only checks publication date",
                3: "Checks date and version numbers",
                4: "Thorough check including API/dependency versions",
                5: "Comprehensive freshness audit with deprecation warnings",
            },
            "accuracy": {
                1: "Freshness assessment is completely wrong",
                2: "Some version/date claims are inaccurate",
                3: "Generally accurate freshness check",
                4: "Accurate with verified version information",
                5: "Precise with links to changelogs and releases",
            },
            "depth": {
                1: "No analysis of staleness impact",
                2: "Basic old/new classification",
                3: "Moderate analysis of what's outdated",
                4: "Deep analysis of breaking changes and migrations",
                5: "Expert assessment of upgrade paths and risks",
            },
            "actionability": {
                1: "No update recommendations",
                2: "Vague suggestions to update",
                3: "Basic update priorities identified",
                4: "Clear upgrade recommendations with versions",
                5: "Detailed migration guide with effort estimates",
            },
        },
    },
    "alternatives_finder": {
        "criteria": ["completeness", "accuracy", "comparison_quality", "actionability"],
        "weights": {
            "completeness": 0.25,
            "accuracy": 0.25,
            "comparison_quality": 0.30,
            "actionability": 0.20,
        },
        "rubrics": {
            "completeness": {
                1: "No alternatives identified",
                2: "Only 1-2 obvious alternatives",
                3: "Good range of alternatives (3-5)",
                4: "Comprehensive alternatives with niche options",
                5: "Exhaustive alternatives including emerging options",
            },
            "accuracy": {
                1: "Alternatives are wrong or don't exist",
                2: "Some alternatives are mischaracterized",
                3: "Generally accurate alternative descriptions",
                4: "Accurate with verified feature comparisons",
                5: "Precise with benchmarks and real-world data",
            },
            "comparison_quality": {
                1: "No comparison between alternatives",
                2: "Superficial feature listing only",
                3: "Basic comparison across key dimensions",
                4: "Thorough comparison with trade-offs",
                5: "Expert comparison with migration considerations",
            },
            "actionability": {
                1: "No guidance on choosing alternatives",
                2: "Vague recommendations",
                3: "Basic decision criteria provided",
                4: "Clear recommendation per use case",
                5: "Decision matrix with scoring methodology",
            },
        },
    },
    "dependency_mapper": {
        "criteria": ["completeness", "accuracy", "depth", "actionability"],
        "weights": {"completeness": 0.30, "accuracy": 0.25, "depth": 0.25, "actionability": 0.20},
        "rubrics": {
            "completeness": {
                1: "No dependencies identified",
                2: "Only direct dependencies listed",
                3: "Covers direct and major transitive deps",
                4: "Thorough dependency tree with versions",
                5: "Complete dependency graph with conflict analysis",
            },
            "accuracy": {
                1: "Dependency information is wrong",
                2: "Some dependencies misidentified or wrong versions",
                3: "Generally accurate dependency listing",
                4: "Accurate with verified version constraints",
                5: "Precise with exact version pins and ranges",
            },
            "depth": {
                1: "No analysis of dependency implications",
                2: "Basic listing without impact analysis",
                3: "Moderate analysis of key dependencies",
                4: "Deep analysis of security and license implications",
                5: "Expert analysis with upgrade impact assessment",
            },
            "actionability": {
                1: "No recommendations for dependency management",
                2: "Vague suggestions about updates",
                3: "Basic dependency health recommendations",
                4: "Clear action items for dependency issues",
                5: "Prioritized dependency remediation plan",
            },
        },
    },
    "code_quality_critic": {
        ...
        "rubrics": {
            "completeness": {
                1: "No quality issues identified",
                2: "Only surface-level style issues found",
                3: "Covers main code quality dimensions",
                4: "Thorough quality review with patterns assessment",
                5: "Comprehensive audit including design and architecture",
            },
            "issue_quality": {
                1: "Issues poorly described or wrong",
                2: "Issues lack severity or specific locations",
                3: "Basic issue descriptions with categories",
                4: "Clear issues with severity and code references",
                5: "Expert issue analysis with impact and root cause",
            },
            "constructiveness": {
                1: "Criticism without solutions",
                2: "Vague improvement suggestions",
                3: "Basic fix suggestions provided",
                4: "Helpful feedback with alternatives",
                5: "Constructive mentorship with examples",
            },
            "accuracy": {
                1: "Major errors in quality assessment",
                2: "Some false positives or misunderstandings",
                3: "Generally accurate assessment",
                4: "Accurate with good understanding of context",
                5: "Highly accurate with deep pattern recognition",
            },
        },
    },
    "trend_validator": {
        "criteria": ["completeness", "accuracy", "evidence_quality", "depth"],
        "weights": {
            "completeness": 0.25,
            "accuracy": 0.30,
            "evidence_quality": 0.25,
        ...
        "rubrics": {
            "completeness": {
                1: "No trend validation performed",
                2: "Only validates 1-2 trends superficially",
                3: "Validates main trends with basic evidence",
                4: "Thorough validation with multiple data points",
                5: "Comprehensive trend analysis with predictions",
            },
            "accuracy": {
                1: "Trend validation is completely wrong",
                2: "Some trends mischaracterized",
                3: "Generally accurate trend assessment",
                4: "Accurate with current market data",
                5: "Precise with authoritative trend sources",
            },
            "evidence_quality": {
                1: "No evidence for trend claims",
                2: "Weak or anecdotal evidence only",
                3: "Basic evidence from known sources",
                4: "Quality evidence with data and citations",
                5: "Authoritative evidence with statistics and reports",
            },
            "depth": {
                1: "Surface-level trend mention only",
                2: "Basic trend identification",
                3: "Moderate analysis of trend implications",
                4: "Deep analysis of trend drivers and impact",
                5: "Expert analysis with forecasting and scenarios",
            },
        },
    },
    "integration_feasibility": {
        "criteria": ["completeness", "feasibility", "risk_awareness", "actionability"],
        "weights": {
            "completeness": 0.25,
            "feasibility": 0.30,
            "risk_awareness": 0.25,
        ...
        "rubrics": {
            "completeness": {
                1: "No integration analysis provided",
                2: "Only surface-level compatibility check",
                3: "Covers main integration points",
                4: "Thorough integration assessment with APIs",
                5: "Comprehensive integration map with data flows",
            },
            "feasibility": {
                1: "Feasibility assessment is wrong or missing",
                2: "Ignores major integration challenges",
                3: "Basic feasibility with some gaps",
                4: "Realistic feasibility with clear constraints",
                5: "Precise feasibility with effort/complexity estimates",
            },
            "risk_awareness": {
                1: "No integration risks identified",
                2: "Only obvious risks mentioned",
                3: "Main risks identified with basic mitigation",
                4: "Thorough risk analysis with strategies",
                5: "Comprehensive risk matrix with contingencies",
            },
            "actionability": {
                1: "No integration guidance provided",
                2: "Vague integration suggestions",
                3: "Basic integration steps outlined",
                4: "Clear integration roadmap with milestones",
                5: "Detailed integration plan with rollback strategy",
            },
        },
    },
    # ========================================================================
    # TIER 3: RESEARCH AGENTS (Deep dive only, memory-enabled)
    # ========================================================================
    "deep_researcher": {
        "criteria": ["completeness", "accuracy", "synthesis", "depth"],
        "weights": {"completeness": 0.25, "accuracy": 0.25, "synthesis": 0.30, "depth": 0.20},
        "rubrics": {
            "completeness": {
                1: "Research is missing or off-topic",
                2: "Only scratches surface of topic",
                3: "Covers main aspects with methodology",
                4: "Thorough research with multiple sources",
                5: "Exhaustive research with comprehensive coverage",
            },
            "accuracy": {
                1: "Major factual errors in research",
                2: "Some inaccuracies or unsupported claims",
                3: "Generally accurate with minor gaps",
                4: "Accurate with verified sources",
                5: "Highly accurate with authoritative references",
            },
            "synthesis": {
                1: "No synthesis, just disconnected facts",
                2: "Minimal synthesis with weak connections",
                3: "Basic synthesis of main themes",
                4: "Good synthesis with insights",
                5: "Excellent synthesis revealing novel connections",
            },
            "depth": {
                1: "Superficial research without analysis",
                2: "Basic coverage without critical evaluation",
                3: "Moderate depth with some analysis",
                4: "Deep research with critical evaluation",
                5: "Expert-level research with implications",
            },
        },
    },
    "community_pulse": {
        "criteria": ["completeness", "accuracy", "sentiment_analysis", "actionability"],
        "weights": {
            "completeness": 0.25,
            "accuracy": 0.25,
            "sentiment_analysis": 0.30,
            "actionability": 0.20,
        },
        "rubrics": {
            "completeness": {
                1: "No community analysis provided",
                2: "Only checks one community source",
                3: "Covers main community channels",
                4: "Thorough community pulse with trends",
                5: "Comprehensive community analysis with demographics",
            },
            "accuracy": {
                1: "Community assessment is completely wrong",
                2: "Some community claims are inaccurate",
                3: "Generally accurate community read",
                4: "Accurate with evidence from discussions",
                5: "Precise with representative sampling",
            },
            "sentiment_analysis": {
                1: "No sentiment analysis performed",
                2: "Basic positive/negative classification",
                3: "Moderate sentiment with key themes",
                4: "Good sentiment analysis with nuance",
                5: "Expert sentiment with trend tracking",
            },
            "actionability": {
                1: "No actionable community insights",
                2: "Vague community recommendations",
                3: "Basic recommendations from community",
                4: "Clear community-driven priorities",
                5: "Strategic roadmap based on community needs",
            },
        },
    },
    "knowledge_curator": {
        "criteria": ["completeness", "organization", "accuracy", "actionability"],
        "weights": {
            "completeness": 0.25,
            "organization": 0.30,
            "accuracy": 0.25,
        ...
        "rubrics": {
            "completeness": {
                1: "No knowledge curation performed",
                2: "Only captures obvious knowledge items",
                3: "Covers main knowledge areas",
                4: "Thorough knowledge capture with gaps identified",
                5: "Comprehensive knowledge map with connections",
            },
            "organization": {
                1: "Knowledge is disorganized or chaotic",
                2: "Poor categorization and structure",
                3: "Basic organization with some hierarchy",
                4: "Well-organized knowledge taxonomy",
                5: "Expert knowledge architecture with navigation",
            },
            "accuracy": {
                1: "Knowledge items are incorrect",
                2: "Some knowledge is outdated or wrong",
                3: "Generally accurate knowledge capture",
                4: "Accurate with source attribution",
                5: "Verified knowledge with confidence levels",
            },
            "actionability": {
                1: "Knowledge not actionable or findable",
                2: "Basic knowledge dump without guidance",
                3: "Some knowledge application guidance",
                4: "Clear knowledge application patterns",
                5: "Knowledge operationalized with workflows",
            },
        },
    },
    "learning_path_advisor": {
        ...
        "rubrics": {
            "completeness": {
                ...
                2: "Major topic gaps, missing core modules",
                3: "Covers core concepts with basic structure",
                4: "Thorough coverage with resources and time estimates",
                5: "Comprehensive curriculum with assessment",
            },
            "pedagogical_quality": {
                1: "No teaching structure or objectives",
                2: "Poor learning flow without clear outcomes",
                3: "Basic educational structure",
                4: "Good pedagogical approach with skill verification",
                5: "Expert instructional design with mastery indicators",
            },
            "progression": {
                1: "No skill progression or random ordering",
    ...
    # ========================================================================
    # TASK-LEVEL AGENTS (Used in synthesis/aggregation)
    # ========================================================================
    "synthesizer": {
        "criteria": ["completeness", "accuracy", "coherence", "depth", "grounding"],
        "weights": {
            "completeness": 0.20,
            "accuracy": 0.20,
            "coherence": 0.20,
        ...
        "rubrics": {
            "completeness": {
                1: "Synthesis is empty or missing major sections",
                2: "Missing most agent findings, incomplete integration",
                3: "Covers main findings but lacks depth in synthesis",
                4: "All major findings integrated with good narrative",
                5: "Comprehensive synthesis with all agents represented",
            },
            "accuracy": {
                1: "Synthesis misrepresents agent findings",
                2: "Some inaccuracies in summarizing findings",
                3: "Generally accurate synthesis of findings",
                4: "Accurate with proper attribution to agents",
                5: "Precise synthesis with faithful representation",
            },
            "coherence": {
                1: "Disorganized, contradictory synthesis",
                2: "Poor organization with disconnected sections",
                3: "Adequate structure with some flow issues",
                4: "Well-organized with clear logical progression",
                5: "Excellent structure with seamless narrative",
            },
            "depth": {
                1: "Superficial summary without insight",
                2: "Basic coverage without analysis",
                3: "Moderate depth with some synthesis",
                4: "Good depth with meaningful integration",
                5: "Exceptional depth revealing cross-agent insights",
            },
            "grounding": {
                1: "Synthesis contains fabricated content",
                2: "Multiple claims not from agent findings",
                3: "Some ungrounded claims but mostly faithful",
                4: "Nearly all content traceable to agent outputs",
                5: "Fully grounded with clear agent attribution",
            },
        },
    },
}
