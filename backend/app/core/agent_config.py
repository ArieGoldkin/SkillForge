...
AGENT_REGISTRY: dict[str, AgentConfig] = {
    ...
    "tech_comparator": AgentConfig(
        ...
        description=(
            "Compare technology with alternatives. "
            "Triggers: framework names, 'vs', 'comparison', 'migrate', 'upgrade', "
            "version discussions"
        ),
    ),
    "security_auditor": AgentConfig(
        ...
        description=(
            "Security risks and vulnerabilities analysis. "
            "Triggers: 'security', 'auth', 'vulnerability', 'authentication', "
    ...
    "implementation_planner": AgentConfig(
        ...
        description=(
            ...
            "Triggers: 'tutorial', 'guide', 'how to', 'setup', 'getting started', 'introduction'"
        ),
    ),
    "performance_analyst": AgentConfig(
        ...
        description=(
            ...
            "Triggers: 'async', 'fast', 'benchmark', 'latency', 'throughput', "
            "'scaling', 'workers', framework perf claims"
        ),
    ),
    "code_quality_critic": AgentConfig(
        ...
        description=(
            "Code patterns, best practices, and maintainability analysis. "
            "Triggers: code examples, 'best practices', 'antipattern', 'refactor'"
        ),
    ),
    "trend_validator": AgentConfig(
        ...
        description=(
            "2025 trends vs legacy/outdated technology validation. "
    ...
    "dependency_mapper": AgentConfig(
        ...
        description=(
            "Map dependencies and ecosystem. "
            "Triggers: imports, requirements.txt, package.json, 'pip install', "
            "'npm install', framework tutorials"
        ),
    ),
