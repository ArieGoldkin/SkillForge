...
class TestInvokeAgent:
    ...
    async def test_ainvoke_success(self, mock_trace_id, mock_agent, input_messages):
    ...
    @pytest.mark.asyncio
    @patch("app.domains.analysis.workflows.agents.invocation.get_current_trace_id")
    async def test_ainvoke_with_langfuse_trace(self, mock_trace_id, mock_agent, input_messages):
        """Test invocation captures Langfuse trace ID."""
        mock_trace_id.return_value = str(uuid4())
    ...
    @pytest.mark.asyncio
    @patch("app.domains.analysis.workflows.agents.invocation.get_current_trace_id")
    async def test_ainvoke_langfuse_unavailable(self, mock_trace_id, mock_agent, input_messages):
        """Test invocation continues when Langfuse is unavailable."""
        mock_trace_id.return_value = None  # No trace context available
    ...
    @pytest.mark.asyncio
    @patch("app.domains.analysis.workflows.agents.invocation.get_current_trace_id")
    async def test_ainvoke_error_raises(self, mock_trace_id, mock_agent, input_messages):
    ...
    @pytest.mark.asyncio
    @patch("app.domains.analysis.workflows.agents.invocation.get_current_trace_id")
    async def test_sync_invoke_fallback(self, mock_trace_id, mock_sync_agent, input_messages):
    ...
    @pytest.mark.asyncio
    @patch("app.domains.analysis.workflows.agents.invocation.get_current_trace_id")
    async def test_sync_invoke_error_raises(self, mock_trace_id, mock_sync_agent, input_messages):
    ...
    @pytest.mark.asyncio
    @patch("app.domains.analysis.workflows.agents.invocation.get_current_trace_id")
    async def test_custom_timeout_parameter(self, mock_trace_id, mock_agent, input_messages):
    ...
    @pytest.mark.asyncio
    @patch("app.domains.analysis.workflows.agents.invocation.get_current_trace_id")
    async def test_langfuse_run_tree_without_id(self, mock_trace_id, mock_agent, input_messages):
        """Test handling when Langfuse trace ID is unavailable."""
        mock_trace_id.return_value = None  # No id available
