...
async def test_generate_syllabus_creates_syllabus(sample_tutor_state, mock_llm_response):
    ...
    with (
        patch(
            "app.domains.tutor.workflows.nodes.generate_syllabus.get_chat_model",
        ...
        patch(
            "app.domains.tutor.services.analysis_service.get_analysis_summary",
            new_callable=AsyncMock,
        ) as mock_analysis,
        patch(
            "app.domains.tutor.workflows.nodes.generate_syllabus._emit_tutor_event",
            new_callable=AsyncMock,
        ),
    ):
